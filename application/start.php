...
Autoloader::map(array(
	...
	'Section' => path('app').'libraries/section.php',
...
|--------------------------------------------------------------------------
|
| This includes the auto-loader generated by Composer which will load
| any of the packages we are using that are distributed through the
| Composer PHP package manager, such as our HAML parser.
|
*/
