...
Class NotificationParser {
  ...
  public static function parse($notification) {
    ...
    if ($notification->notification_type == "Dismissal") {
      ...
      $return_array["line1"] = $bid["vendor"]["company_name"]." has <a data-pjax href='".route('bid', array($bid["project"]["id"], $bid["id"])).
      ...
      $return_array["line1"] = "You have been added as a collaborator on  <a data-pjax href='".route('project', array($project["id"]))."'>".$project["title"]."</a>.";
