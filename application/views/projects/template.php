...
<?php if ($templates): ?>
  ...
  <ul class="templates-list">
    ...
    <?php if ($more_templates_count): ?>
      <li class="show-more">
        <a class="show-more-templates-link" data-href="<?php echo route('project_more_templates', array($project->id)); ?>">See <?php echo $more_templates_count; ?> more <?php echo Str::plural('template', $more_templates_count); ?>...</a>
        <img class="spinner" src="<?php echo asset('img/spinner.gif'); ?>" />
      </li>
    <?php endif; ?>
  </ul>
  ...
  <div class="centered">
    <a class="btn btn-primary" href="<?php echo route('project_background', array($project->id)); ?>">Start From Scratch</a>
  </div>
<?php else: ?>
  <p class="well">
    <?php echo __("r.projects.template.no_templates", array("project_type" => $project->project_type->name)); ?>
    <div class="centered">
      <a class="btn btn-primary" href="<?php echo route('project_background', array($project->id)); ?>">Let's get started! &rarr;</a>
    </div>
  </p>
<?php endif; ?>