...
<div class="row-fluid">
  <div class="span7">
    <h5>Step 1</h5>
    <p><?php echo Jade\Dumper::_html(__("r.projects.post_on_fbo.step1")); ?></p>
    ...
    <h5>Step 2</h5>
    <p><?php echo Jade\Dumper::_html(__("r.projects.post_on_fbo.step2", array("due" => $project->formatted_proposals_due_at(), "url" => route('project_admin', array($project->id))))); ?></p>
  ...
  <div class="span4 offset1">
    <div class="well">
      ...
      <p><?php echo Jade\Dumper::_html(__("r.projects.post_on_fbo.not_co")); ?></p>
    </div>
  </div>
</div>