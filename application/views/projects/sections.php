...
<?php echo Jade\Dumper::_html(View::make('projects.partials.add_edit_section_modal')->with('project', $project)->with('available_sections', $available_sections)); ?>
<div class="row-fluid">
  <div class="span3">
  ...
  <div class="span9">
    ...
    <div class="form-actions">
      <a class="btn btn-primary" href="<?php echo Jade\Dumper::_text(route('project_blanks', array($project->id))); ?>">Save and Continue &rarr;</a>
    </div>
  </div>
</div>