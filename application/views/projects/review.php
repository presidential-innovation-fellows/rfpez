...
<div class="row-fluid">
  ...
  <div class="span9">
    <div class="well"><?php echo Jade\Dumper::_html(__("r.projects.review.text", array("post_url" => route('project_post_on_fbo', array($project->id)), "invite_url" =>route('project_admin', array($project->id))))); ?>
</div>
