...
<div class="span5">
  ...
  <a class="btn btn-warning btn-large" href="<?php echo Jade\Dumper::_text( route('new_vendors') ); ?>">Register as a Company</a>
</div>
<div class="span5">
  ...
  <a class="btn btn-warning btn-large" href="<?php echo Jade\Dumper::_text( route('new_officers') ); ?>">Register as a Contracting Officer</a>
</div>