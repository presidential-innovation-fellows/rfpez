...
<div class="hero-unit">
  <h1>
    EasyBid
    <small><?php echo __('r.home.index_signed_out.site_tagline'); ?></small>
  </h1>
</div>
<div class="row-fluid">
  <div class="span6">
    ...
    <a class="btn btn-warning btn-large" href="<?php echo  route('new_vendors') ; ?>" data-pjax="data-pjax"><?php echo __('r.home.index_signed_out.biz_button'); ?></a>
  </div>
  <div class="span6">
    ...
    <a class="btn btn-warning btn-large" href="<?php echo  route('new_officers') ; ?>" data-pjax="data-pjax"><?php echo __('r.home.index_signed_out.gov_button'); ?></a>
  </div>
</div>