...
<div class="vendor-detail">
  <div class="company-name pull-left"><?php echo $vendor->company_name; ?></div>
  <div class="homepage-url btn pull-right">
    <a href="<?php echo $vendor->homepage_url; ?>" target="_blank">view company website</a>
  </div>
  <div class="clearfix"></div>
  <div class="ballpark-price"><?php echo $vendor->ballpark_price_display(); ?></div>
  <hr class="dark" />
  <div class="more-info">
    <p><?php echo $vendor->more_info; ?></p>
  </div>
